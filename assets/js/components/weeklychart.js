// ================= WEEKLY CHART MODULE =================
// renders Mon–Fri activity bar chart with tooltip + animation

document.addEventListener("DOMContentLoaded", async () => {

    // ================= TOOLTIP SYSTEM =================
    // floating hover info for bar details (global overlay)
    ...
    // IMPORTANT:
    // no user → no chart (avoids unnecessary Firestore queries)
    if (!userDocId) return;
    ...
    // ================= HELPERS =================
    // time + date utilities (kept isolated for readability)
    ...
    // ================= WEEK STRUCTURE =================
    // builds Mon–Fri reference dates for current week
    ...
    // ================= FIRESTORE FETCH =================
    // parallel queries for each weekday (simple but effective)
    ...
    labels.forEach((label, i) => {
        ...
        // ================= COLOR SYSTEM =================
        // visual intensity based on workload
        let color = "#e0e0e0";
