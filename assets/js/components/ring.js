...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // =========================
  // START POSITION (TOP + COUNTER-CLOCKWISE)
  // =========================
  ...
  // =========================
  // DAYS PRESENT (OJ T RECORDS - ABSENT)
  // =========================
  ...
  safeAbsent === 1 ? "1 Absence" : `${safeAbsent} Absences`;
    ...
    document.getElementById("daysText").innerHTML =
        `${presentDays} Days Completed<br><span style="font-size:12px; color:#777; font-weight:600;">${absenceText}</span>`;
